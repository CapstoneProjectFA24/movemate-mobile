...
class _OrderSource implements OrderSource {
  ...
  Future<HttpResponse<BookingNewResponse>> getBookingNewById(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<BookingNewResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final _value = BookingNewResponse.fromMap(_result.data!);
    final httpResponse = HttpResponse(_value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<SuccessModel>> changeBookingAt(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      contentType: contentType,
            ...
            .compose(
              _dio.options,
              '/bookings/user/change-bookingat/${id}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HttpResponse<ServiceResponse>> getAllService(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<ServiceResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final _value = ServiceResponse.fromMap(_result.data!);
    final httpResponse = HttpResponse(_value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<SuccessModel>> postUserReport(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(object?.toMap() ?? <String, dynamic>{});
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<SuccessModel>>(Options(
      method: 'POST',
      headers: _headers,
