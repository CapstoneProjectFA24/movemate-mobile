...
class _ProfileSource implements ProfileSource {
  ...
  Future<HttpResponse<ProfileResponse>> getProfileInfor(
    ...
    final _value = ProfileResponse.fromMap(_result.data!);
  ...
  Future<HttpResponse<StaffProfileResponse>> getProfileDriverInforById(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<StaffProfileResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final _value = StaffProfileResponse.fromMap(_result.data!);
    final httpResponse = HttpResponse(_value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<WalletResponse>> getWallet(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<WalletResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final _value = WalletResponse.fromMap(_result.data!);
    final httpResponse = HttpResponse(_value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<SuccessModel>> withDrawWallet(
    String contentType,
    String accessToken,
    WithDrawQueries amount,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(amount.toMap());
    final _headers = <String, dynamic>{
      r'Content-Type': contentType,
      r'Authorization': accessToken,
    };
  ...
  Future<HttpResponse<TransactionResponse>> getTransactionByUserId(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<TransactionResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final _value = TransactionResponse.fromMap(_result.data!);
    final httpResponse = HttpResponse(_value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<IncidentResponse>> getIncidentListByUserId(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<IncidentResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final _value = IncidentResponse.fromMap(_result.data!);
    final httpResponse = HttpResponse(_value, _result);
    return httpResponse;
  }
